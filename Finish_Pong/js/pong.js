...
var scoreBoard;
var player = [
    new User().setProps({h:150, force:1, fill:`#FF00E6`, stroke:`#FFFFFF`}), 
    new User().setProps({h:150, force:1, fill:`#00FFEA`, stroke:`#FFFFFF`, keys:{u:`ArrowUp`, d:`ArrowDown`, s:`ArrowLeft`}}) 
]
...
{   
    ...
    //ball
    o[2] = new Box().setProps({w:20, h:20, vx:-2, vy:0, fill:`#00FF00`}); 

    //goals 1 and 2
    o[3] = new Box().setProps({x:o[0].x + ((c.width +10 ) * o[0].dir), h:c.height, w:20, fill:`#00FF00`}); 
    o[4] = new Box().setProps({x:o[1].x + ((c.width +10 ) * o[1].dir), h:c.height, w:20, fill:`#FF0000`}); 
